...
export function customTokens(t: (key: string) => string): typeof Blockly.Msg {
  return {
    ...
    CONTROLLER_TOOLTIP: t('BLOCKLY.TOOLTIP.CONTROLLER'),
    ...
    MRC_CATEGORY_TELEMETRY: t('BLOCKLY.CATEGORY.TELEMETRY'),
    MRC_CATEGORY_CONTROLLERS: t('BLOCKLY.CATEGORY.CONTROLLERS'),
    MRC_CATEGORY_ADD_MECHANISM: t('BLOCKLY.CATEGORY.ADD_MECHANISM'),
    MRC_CATEGORY_ADD_COMPONENT: t('BLOCKLY.CATEGORY.ADD_COMPONENT'),
    MRC_CATEGORY_ADD_CONTROLLER: t('BLOCKLY.CATEGORY.ADD_CONTROLLER'),
    MRC_CATEGORY_TEST: t('BLOCKLY.CATEGORY.TEST'),
    MRC_PRINT: t('BLOCKLY.PRINT'),
    MRC_CONTROLLERS: t('BLOCKLY.CONTROLLERS'),
